...
void NAME_OVERLAY_FUNCTION(Balloonist1)(Moby *pBalloonist) {
  ...
  g_StateSwitch = 1;
  D_800777E8.unk_0x38 = Atan2(g_Camera.m_Position.x - pBalloonist->m_Position.x,
  ...
  switch (D_800777E8.m_State) {
    case 0: {
      ...
      if (D_800777E8.unk_0x04 < 96) {
        ...
        if (D_800777E8.unk_0x04 == g_DeltaTime) {
          ...
          VecRotateByMatrix((MATRIX*)&D_800777E8.m_BalloonistMoby->m_RotationMatrix, &D_800777E8.unk_0x2C, &D_800777E8.unk_0x2C);
          VecAdd(&D_800777E8.unk_0x2C, &D_800777E8.unk_0x2C, &D_800777E8.m_BalloonistMoby->m_Position);
        ...
        if (D_800777E8.unk_0x04 < 24) {
          ...
          if ((D_800777E8.unk_0x34 - D_800777E8.unk_0x30 & 0xfff) <= 0x800) {
            g_Spyro.m_bodyRotation.z = (D_800777E8.unk_0x30 + (func_80017928(D_800777E8.unk_0x34, D_800777E8.unk_0x30) * temp >> 13)) >> 4;
          } else {
            g_Spyro.m_bodyRotation.z = (D_800777E8.unk_0x30 - (func_80017928(D_800777E8.unk_0x34, D_800777E8.unk_0x30) * temp >> 13)) >> 4;
          }
          g_Spyro.m_bodyAnimationSpeed = 8;
        } else if (D_800777E8.unk_0x04 < 72) {
          int temp = (Sin(((D_800777E8.unk_0x04 - 24) * 0x800) / 48 - 0x400) + 0x1000);
          VecSub(&vec, &D_800777E8.unk_0x2C, &D_800777E8.unk_0x18);
          ...
          int temp = Sin(((D_800777E8.unk_0x04 - 72) * 0x800) / 24 - 0x400) + 0x1000;
          if (D_800777E8.unk_0x04 - g_DeltaTime < 72) {
            D_800777E8.unk_0x30 = g_Spyro.m_bodyRotation.z << 4;
            D_800777E8.unk_0x34 = D_800777E8.m_BalloonistMoby->m_Rotation.z * 16 - 0x800 & 0xfff;
        ...
        if ((D_800777E8.unk_0x50 - D_800777E8.unk_0x38 & 0xfff) <= 0x800) {
          interpAngle = D_800777E8.unk_0x38 + (func_80017928(D_800777E8.unk_0x50, D_800777E8.unk_0x38) * lerpProgress >> 13);
        } else {
          interpAngle = D_800777E8.unk_0x38 - (func_80017928(D_800777E8.unk_0x50, D_800777E8.unk_0x38) * lerpProgress >> 13);
        }

        interpRadius = (D_800777E8.unk_0x3c + ((D_800777E8.unk_0x54 - D_800777E8.unk_0x3c) * lerpProgress >> 13));
        g_Camera.m_Position.x = D_800777E8.m_BalloonistMoby->m_Position.x + (Cos(interpAngle) * interpRadius >> 12);
        g_Camera.m_Position.y = D_800777E8.m_BalloonistMoby->m_Position.y + (Sin(interpAngle) * interpRadius >> 12);
        g_Camera.m_Position.z = D_800777E8.unk_0x40 + (((D_800777E8.unk_0x58 - D_800777E8.unk_0x40) * lerpProgress) >> 13);

        vec.x = 0x220;
        vec.y = 0;
        vec.z = 0x340;
        VecRotateByMatrix((MATRIX*)&D_800777E8.m_BalloonistMoby->m_RotationMatrix, &vec, &vec);
        ...
        if (D_800777E8.unk_0x04 < 32) {
          ...
          g_Camera.m_Rotation.x = g_Camera.m_Rotation.x + (func_8001796C(shortvec.x, g_Camera.m_Rotation.x) * D_800777E8.unk_0x04 >> 5) & 0xfff;
          g_Camera.m_Rotation.y = g_Camera.m_Rotation.y + (func_8001796C(shortvec.y, g_Camera.m_Rotation.y) * D_800777E8.unk_0x04 >> 5) & 0xfff;
          g_Camera.m_Rotation.z = g_Camera.m_Rotation.z + (func_8001796C(shortvec.z, g_Camera.m_Rotation.z) * D_800777E8.unk_0x04 >> 5) & 0xfff;
        } else {
        ...
        g_Camera.m_Position.x = D_800777E8.m_BalloonistMoby->m_Position.x + ((Cos(D_800777E8.unk_0x50) * D_800777E8.unk_0x54) >> 12);
        g_Camera.m_Position.y = D_800777E8.m_BalloonistMoby->m_Position.y + ((Sin(D_800777E8.unk_0x50) * D_800777E8.unk_0x54) >> 12);
    ...
    case 1: {
      if (D_800777E8.m_DialogueId < 30) {
        if ((g_Pad.m_Down & (PAD_CROSS | PAD_START | PAD_RIGHT | PAD_DOWN)) && (D_800777E8.unk_0x04 > 80)) {
        ...
        if ((g_Pad.m_Down & (PAD_CROSS | PAD_START)) && D_800777E8.unk_0x04 >= 31) {
          if (D_800777E8.unk_0x08 == 0) {
            (*D_800758A8)();
          } else {
            func_80056B28(0);
        ...
        if ((g_Pad.m_Down & (PAD_CROSS | PAD_START)) && D_800777E8.unk_0x04 >= 0x1f) {
          if (D_800777E8.unk_0x08 == 0) {
      ...
      } else if ((g_Pad.m_Down & (PAD_CROSS | PAD_START | PAD_RIGHT | PAD_DOWN)) && D_800777E8.unk_0x04 > 80) {
    ...
    case 2: {
      ...
      if (D_800777E8.unk_0x04 < 102) {
        ...
        if (D_800777E8.unk_0x04 == g_DeltaTime) {
          ...
          D_800777E8.unk_0x38 = Atan2(g_Camera.m_Position.x - D_800777E8.m_BalloonMoby->m_Position.x,
          ...
          D_800777E8.unk_0x50 = D_800777E8.m_BalloonMoby->m_Rotation.z * 0x10 - 0x480 & 0xfff;
          ...
          D_800777E8.unk_0x5C[1] = D_800777E8.m_BalloonistMoby->m_Position.z + 0x488;
          VecCopy(&D_800777E8.unk_0x18, &g_Spyro.m_Position);
        ...
        if (D_800777E8.unk_0x04 < 48) {
          g_Spyro.m_Position.x = D_800777E8.unk_0x18.x + ((D_800777E8.unk_0x2C.x - D_800777E8.unk_0x18.x) * D_800777E8.unk_0x04) / 48;
          g_Spyro.m_Position.y = D_800777E8.unk_0x18.y + ((D_800777E8.unk_0x2C.y - D_800777E8.unk_0x18.y) * D_800777E8.unk_0x04) / 48;
          g_Spyro.m_Position.z = D_800777E8.unk_0x18.z + (Sin(D_800777E8.unk_0x04 << 5) * 10) / 0x24;
          g_Spyro.m_surfaceBelowSpyro = func_8004D5EC(&g_Spyro.m_Position, 0x10000);
          RotVec8ToMatrix(&g_Spyro.m_bodyRotation, &g_Spyro.m_RotationMatrix, 0);
          func_80049FAC(1);
        } else {
          ...
          if (53 < D_800777E8.unk_0x04 - g_DeltaTime) {
            g_Spyro.m_bodyAnimationSpeed = 7;
            g_Spyro.m_Position.x = D_800777E8.unk_0x18.x + ((D_800777E8.unk_0x2C.x - D_800777E8.unk_0x18.x) * (D_800777E8.unk_0x04 - 54)) / 48;
            g_Spyro.m_Position.y = D_800777E8.unk_0x18.y + ((D_800777E8.unk_0x2C.y - D_800777E8.unk_0x18.y) * (D_800777E8.unk_0x04 - 54)) / 48;
            g_Spyro.m_Position.z = D_800777E8.unk_0x18.z + (Sin((D_800777E8.unk_0x04 - 54) * 32) >> 2);
          }
        }
        if ((D_800777E8.unk_0x50 - D_800777E8.unk_0x38 & 0xfff) < 0x801) {
          currentAngle = D_800777E8.unk_0x38 + (func_80017928(D_800777E8.unk_0x50, D_800777E8.unk_0x38) * lerpProgress >> 13);
        } else {
          currentAngle = D_800777E8.unk_0x38 - (func_80017928(D_800777E8.unk_0x50, D_800777E8.unk_0x38) * lerpProgress >> 13);
        }
        currentDist = D_800777E8.unk_0x3c + ((D_800777E8.unk_0x54 - D_800777E8.unk_0x3c) * lerpProgress >> 13);
        g_Camera.m_Position.x = D_800777E8.m_BalloonMoby->m_Position.x + (Cos(currentAngle) * currentDist >> 0xc);
        g_Camera.m_Position.y = D_800777E8.m_BalloonMoby->m_Position.y + (Sin(currentAngle) * currentDist >> 0xc);
        g_Camera.m_Position.z = D_800777E8.unk_0x40 + ((D_800777E8.unk_0x58 - D_800777E8.unk_0x40) * lerpProgress >> 13);
        VecSub(&vec, &D_800777E8.m_BalloonMoby->m_Position, &g_Camera.m_Position);
        shortvec.y = Atan2(VecMagnitude(&vec, 0), -vec.z, 1);
        shortvec.z = Atan2(vec.x, vec.y, 1);
        g_Camera.m_Rotation.y = D_800777E8.unk_0x44.y + (func_8001796C(shortvec.y, D_800777E8.unk_0x44.y) * lerpProgress >> 13) & 0xfff;
        g_Camera.m_Rotation.z = D_800777E8.unk_0x44.z + (func_8001796C(shortvec.z, D_800777E8.unk_0x44.z) * lerpProgress >> 13) & 0xfff;
        D_800777E8.m_BalloonMoby->m_Position.z = D_800777E8.unk_0x5C[0] + ((D_800777E8.unk_0x5C[1] - D_800777E8.unk_0x5C[0]) * lerpProgress >> 13);
      } else {
    ...
    case 3: {
      ...
      if (0x7f >= D_800777E8.unk_0x04) {
        ...
        if (D_800777E8.unk_0x04 < 0x40) {
          D_800777E8.m_BalloonMoby->m_Position.z = D_800777E8.unk_0x5C[0] + ((Sin(D_800777E8.unk_0x04 * 0x10 + 0xc00) + 0x1000) * 3 >> 2);
        } else {
          D_800777E8.m_BalloonMoby->m_Position.z = D_800777E8.m_BalloonMoby->m_Position.z + g_DeltaTime * 75;
          g_Camera.m_Position.z = D_800777E8.unk_0x40 + ((Sin(D_800777E8.unk_0x04 * 0x10 + 0x800) + 0x1000) * 3 >> 2);
        }
        VecSub(&vec, &D_800777E8.m_BalloonMoby->m_Position, &g_Camera.m_Position);
        g_Camera.m_Rotation.y = Atan2(VecMagnitude(&vec, 0), -vec.z, 1);
        ...
        D_800777E8.unk_0x38 = Atan2(g_Camera.m_Position.x - D_800777E8.m_BalloonMoby->m_Position.x, g_Camera.m_Position.y - D_800777E8.m_BalloonMoby->m_Position.y, 1);
        VecSub(&vec, &g_Camera.m_Position, &D_800777E8.m_BalloonMoby->m_Position);
        D_800777E8.unk_0x3c = VecMagnitude(&vec, 0);
        D_800777E8.unk_0x40 = g_Camera.m_Position.z;
        D_800777E8.unk_0x50 = (0x390 + D_800777E8.m_BalloonMoby->m_Rotation.z * 0x10) & 0xfff;
        ...
        D_800777E8.unk_0x04 = 0;
        LoadLevel(1);
        Memcpy(&g_SonyImage.m_WorldFarQueued[106], D_800777E8.m_BalloonMoby, 0x58);
        ...
        g_Models[416]->m_Animations[0] = (AnimationHeader*)((int)g_Models[416]->m_Animations[0] + ptrDiff);
        g_Models[416]->m_Animations[0]->m_Faces = (void*)((int)g_Models[416]->m_Animations[0]->m_Faces + ptrDiff);
        g_Models[416]->m_Animations[0]->m_Colors = (void*)((int)g_Models[416]->m_Animations[0]->m_Colors + ptrDiff);
    ...
    case 5: {
      ...
      if (D_800777E8.unk_0x04 < 0x100) {
        ...
        if ((D_800777E8.unk_0x38 - D_800777E8.unk_0x50 & 0xfff) <= 0x800) {
          angle = D_800777E8.unk_0x50 + (func_80017928(D_800777E8.unk_0x38, D_800777E8.unk_0x50) * sineProgress >> 13);
        } else {
          angle = D_800777E8.unk_0x50 - (func_80017928(D_800777E8.unk_0x38, D_800777E8.unk_0x50) * sineProgress >> 13);
        }
        dist = D_800777E8.unk_0x54 + ((D_800777E8.unk_0x3c - D_800777E8.unk_0x54) * sineProgress >> 13);
        g_Camera.m_Position.x = D_800777E8.m_BalloonMoby->m_Position.x + (Cos(angle) * dist >> 12);
        g_Camera.m_Position.y = D_800777E8.m_BalloonMoby->m_Position.y + (Sin(angle) * dist >> 12);
        g_Camera.m_Position.z = D_800777E8.unk_0x58 + ((D_800777E8.unk_0x40 - D_800777E8.unk_0x58) * sineProgress >> 13);
        VecSub(&vec, &D_800777E8.m_BalloonMoby->m_Position, &g_Camera.m_Position);
    ...
    case 6: {
      ...
      if (0x7f >= D_800777E8.unk_0x04) {
        ...
        if (D_800777E8.unk_0x04 < 0x40) {
          ...
          g_Camera.m_Position.z = D_800777E8.unk_0x40 + (Sin(-D_800777E8.unk_0x04 * 0x10) * 3 >> 2);
        } else {
          if (D_800777E8.unk_0x04 - g_DeltaTime < 0x40) {
            D_800777E8.unk_0x5C[0] = D_800777E8.m_BalloonMoby->m_Position.z - 75;
          }
          D_800777E8.m_BalloonMoby->m_Position.z = D_800777E8.unk_0x5C[0] + (Sin(0x400 - D_800777E8.unk_0x04 * 0x10) * 3 >> 2);
        }
        VecSub(&vec, &D_800777E8.m_BalloonMoby->m_Position, &g_Camera.m_Position);
        g_Camera.m_Rotation.y = Atan2(VecMagnitude(&vec, 0), -vec.z, 1);
        g_Camera.m_Rotation.z = Atan2(vec.x, vec.y, 1);
        ...
        D_800777E8.unk_0x2C.z = func_8004D5EC(&D_800777E8.unk_0x2C, 0x10000) + 0x164;
        g_Spyro.m_nextBodyAnimation = 5;
        g_Spyro.m_bodyAnimationFrame = g_Spyro.m_nextBodyAnimationFrame;
        g_Spyro.m_nextBodyAnimationFrame = 0;
        g_Spyro.m_bodyFrameProgress = 0;
    ...
    case 7: {
      int pad[2];
      if (D_800777E8.unk_0x04 < 0x40) {
        g_Spyro.m_Position.x = D_800777E8.unk_0x18.x + ((D_800777E8.unk_0x2C.x - D_800777E8.unk_0x18.x) * D_800777E8.unk_0x04 >> 6);
        g_Spyro.m_Position.y = D_800777E8.unk_0x18.y + ((D_800777E8.unk_0x2C.y - D_800777E8.unk_0x18.y) * D_800777E8.unk_0x04 >> 6);
        g_Spyro.m_Position.z = D_800777E8.unk_0x2C.z + (Sin(D_800777E8.unk_0x04 * 24 + 0x200) * (D_800777E8.unk_0x18.z - D_800777E8.unk_0x2C.z)) / 0xb50;
        g_Spyro.m_surfaceBelowSpyro = func_8004D5EC(&g_Spyro.m_Position, 0x10000);
        RotVec8ToMatrix(&g_Spyro.m_bodyRotation, &g_Spyro.m_RotationMatrix, 0);
        func_80049FAC(1);
        if (0x1f < D_800777E8.unk_0x04) {
          D_800777E8.m_BalloonMoby->m_Position.z += D_800777E8.unk_0x04 * g_DeltaTime;
        }
      } else {
        VecCopy(&g_Spyro.m_Position, &D_800777E8.unk_0x2C);
        func_8004AC24(1);
        ...
        D_8006C8BC.m_Coords.azimuth = D_8006C8BC.m_Coords.azimuth + g_Camera.m_FocusRotation & 0xfff;
        func_80034358();
        HudReset(0);
        g_Gamestate = 0;
        g_StateSwitch = 1;
...
void NAME_OVERLAY_FUNCTION(Balloonist4)(void) {
  if (D_800777E8.m_State <= 3) {
    if (D_800777E8.m_State <= 1) {
      ...
      sprintf(buffer, "%s THE BALLOONIST", g_BalloonistNames[g_LevelId / 10 - 1]);
      ...
      for (i = 0; (int)g_HudMobys <= (int)hudmobyptr; i++) {
        hudmobyptr->m_Rotation.z = D_8006CC78[(D_800777E8.unk_0x04 * 4 + (i * 12) & 0xff)] >> 8;
        hudmobyptr--;
      }
    }
    if (D_800777E8.m_State == 1) {
      if (D_800777E8.m_DialogueId <= 29 || D_800777E8.m_DialogueId >= 33) {
        ...
        vec2.y = 0x1;
        vec2.z = 0x1400;
        for (i = g_BalloonistDialogueIndices[D_800777E8.m_DialogueId]; i < g_BalloonistDialogueIndices[D_800777E8.m_DialogueId + 1]; i++) {
          vec1.x = 0x5e;
          func_800181AC((char*)g_BalloonistDialogue[i], &vec1, &vec2, 0x12, 0xb);
          vec1.y += 0x12;
        }
        if (D_800777E8.unk_0x04 < 80) {
          if ((int)g_HudMobys <= (int)(hudmobyptr - D_800777E8.unk_0x04)) g_HudMobys = hudmobyptr - D_800777E8.unk_0x04;
        }
        hudmobyptr--;
        for (i = 0; (int)g_HudMobys <= (int)hudmobyptr; i++) {
          hudmobyptr->m_Rotation.z = D_8006CC78[(D_800777E8.unk_0x04 * 4 + (i * 12) & 0xff)] >> 8;
        ...
        for (i = 0; i < 6; i++) {
          if (g_LevelId / 10 - 1 != i && D_800758D0[i] == 2) {
            vec1.x = 0x110;
            hudmobyptr = g_HudMobys - 1;
            func_800181AC((char*)g_HomeworldNames[i], &vec1, &vec2, 0x10, 0xb);
            vec1.y += 0xf;
            if (D_800777E8.unk_0x08 == someflag) {
              for (j = 0; g_HudMobys <= hudmobyptr; j++) {
                hudmobyptr->m_Rotation.z = D_8006CC78[(D_800777E8.unk_0x04 * 4 + (j * 12) & 0xff)] >> 8;
                hudmobyptr--;
              }
            }
            someflag++;
        ...
        if (D_800777E8.m_DialogueId == 31) {
          sprintf(buffer,
          (char*)(char[])
          {'G', 'O', ' ', 'T', 'O', ' ', '%', 's', GARBAGE_FIX},
          g_HomeworldNames[g_LevelId / 10]);
        } else {
          sprintf(buffer,
          (char*)(char[])
          {'G', 'O', ' ', 'T', 'O', ' ', '%', 's', GARBAGE_FIX},
          g_HomeworldNames[7 + (g_NextLevelId / 10 - 1) * 6 + g_NextLevelId % 10]);
        }
        #undef GARBAGE_FIX
