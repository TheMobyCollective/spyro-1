...
// Balloonist funcs are generically named for now, here and in overlay_pointers.c
#define b(level) \
    void NAME_OVERLAY_FUNCTION_LEVEL(Balloonist1, level)(Moby* bBalloonist); \
    void NAME_OVERLAY_FUNCTION_LEVEL(Balloonist2, level)(void); \
    void NAME_OVERLAY_FUNCTION_LEVEL(Balloonist3, level)(void); \
    void NAME_OVERLAY_FUNCTION_LEVEL(Balloonist4, level)(void);
