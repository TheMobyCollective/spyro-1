...
/* 3A7E4 80049FE4 125C000C */  jal        func_80017048
...
/* 3A7FC 80049FFC 0880043C */  lui        $a0, %hi(D_8007AA20)
/* 3A800 8004A000 20AA8424 */  addiu      $a0, $a0, %lo(D_8007AA20)
...
/* 3A820 8004A020 0880013C */  lui        $at, %hi(D_8007AA28)
/* 3A824 8004A024 28AA24AC */  sw         $a0, %lo(D_8007AA28)($at)
...
/* 3A844 8004A044 0880013C */  lui        $at, %hi(D_8007AA2C)
/* 3A848 8004A048 2CAA23AC */  sw         $v1, %lo(D_8007AA2C)($at)
...
/* 3A85C 8004A05C 0880013C */  lui        $at, %hi(D_8007AA2C)
/* 3A860 8004A060 2CAA22AC */  sw         $v0, %lo(D_8007AA2C)($at)
.L8004A064:
/* 3A864 8004A064 0780023C */  lui        $v0, %hi(D_80075964)
/* 3A868 8004A068 6459428C */  lw         $v0, %lo(D_80075964)($v0)
/* 3A86C 8004A06C 0880013C */  lui        $at, %hi(D_8007AA34)
/* 3A870 8004A070 34AA20AC */  sw         $zero, %lo(D_8007AA34)($at)
...
.L8004A0A4:
/* 3A8A4 8004A0A4 0880013C */  lui        $at, %hi(D_8007AA34)
/* 3A8A8 8004A0A8 34AA22AC */  sw         $v0, %lo(D_8007AA34)($at)
.L8004A0AC:
/* 3A8AC 8004A0AC 0880113C */  lui        $s1, %hi(D_8007AA30)
/* 3A8B0 8004A0B0 30AA3126 */  addiu      $s1, $s1, %lo(D_8007AA30)
...
/* 3A8F0 8004A0F0 125C000C */  jal        func_80017048
...
/* 3A944 8004A144 0880023C */  lui        $v0, %hi(D_8007AA30)
/* 3A948 8004A148 30AA428C */  lw         $v0, %lo(D_8007AA30)($v0)
...
.L8004A160:
/* 3A960 8004A160 0880023C */  lui        $v0, %hi(D_8007AA30)
/* 3A964 8004A164 30AA428C */  lw         $v0, %lo(D_8007AA30)($v0)
/* 3A968 8004A168 00000000 */  nop
/* 3A96C 8004A16C 21104300 */  addu       $v0, $v0, $v1
/* 3A970 8004A170 000040A0 */  sb         $zero, 0x0($v0)
/* 3A974 8004A174 0880033C */  lui        $v1, %hi(D_8007AA28)
/* 3A978 8004A178 28AA638C */  lw         $v1, %lo(D_8007AA28)($v1)
...
/* 3A998 8004A198 0880033C */  lui        $v1, %hi(D_8007AA30)
/* 3A99C 8004A19C 30AA638C */  lw         $v1, %lo(D_8007AA30)($v1)
...
.L8004A1BC:
/* 3A9BC 8004A1BC 0880023C */  lui        $v0, %hi(D_8007AA30)
/* 3A9C0 8004A1C0 30AA428C */  lw         $v0, %lo(D_8007AA30)($v0)
/* 3A9C4 8004A1C4 E8FF2326 */  addiu      $v1, $s1, -0x18
/* 3A9C8 8004A1C8 21104300 */  addu       $v0, $v0, $v1
/* 3A9CC 8004A1CC 000040A0 */  sb         $zero, 0x0($v0)
.L8004A1D0:
/* 3A9D0 8004A1D0 0880023C */  lui        $v0, %hi(D_8007AA30)
/* 3A9D4 8004A1D4 30AA428C */  lw         $v0, %lo(D_8007AA30)($v0)
