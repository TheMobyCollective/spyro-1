...
/* 1D24C 8002CA4C 0780103C */  lui        $s0, %hi(g_DragonCutscene + 0x28)
/* 1D250 8002CA50 58701026 */  addiu      $s0, $s0, %lo(g_DragonCutscene + 0x28)
...
/* 1D294 8002CA94 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x2C)
/* 1D298 8002CA98 5C7020AC */  sw         $zero, %lo(g_DragonCutscene + 0x2C)($at)
/* 1D29C 8002CA9C 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x3C)
/* 1D2A0 8002CAA0 6C7020AC */  sw         $zero, %lo(g_DragonCutscene + 0x3C)($at)
/* 1D2A4 8002CAA4 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x50)
/* 1D2A8 8002CAA8 807020AC */  sw         $zero, %lo(g_DragonCutscene + 0x50)($at)
/* 1D2AC 8002CAAC 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x5C)
/* 1D2B0 8002CAB0 8C7020AC */  sw         $zero, %lo(g_DragonCutscene + 0x5C)($at)
/* 1D2B4 8002CAB4 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x58)
/* 1D2B8 8002CAB8 887020AC */  sw         $zero, %lo(g_DragonCutscene + 0x58)($at)
...
/* 1D2D0 8002CAD0 0780013C */  lui        $at, %hi(g_DragonCutscene + 0x24)
/* 1D2D4 8002CAD4 547022AC */  sw         $v0, %lo(g_DragonCutscene + 0x24)($at)
...
.L8002CB10:
/* 1D310 8002CB10 0780043C */  lui        $a0, %hi(D_80076248 + 0x4)
/* 1D314 8002CB14 4C628424 */  addiu      $a0, $a0, %lo(D_80076248 + 0x4)
...
/* 1D328 8002CB28 0780023C */  lui        $v0, %hi(D_80076248 + 0xC)
/* 1D32C 8002CB2C 5462428C */  lw         $v0, %lo(D_80076248 + 0xC)($v0)
...
/* 1D33C 8002CB3C 0780013C */  lui        $at, %hi(D_80076248 + 0xC)
/* 1D340 8002CB40 546222AC */  sw         $v0, %lo(D_80076248 + 0xC)($at)
