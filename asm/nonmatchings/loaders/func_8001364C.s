...
/* 3E80 80013680 0880103C */  lui        $s0, %hi(D_800785E4)
/* 3E84 80013684 E485108E */  lw         $s0, %lo(D_800785E4)($s0)
...
.L80013768:
/* 3F68 80013768 0780023C */  lui        $v0, %hi(D_800758AC)
/* 3F6C 8001376C AC58428C */  lw         $v0, %lo(D_800758AC)($v0)
...
/* 3F80 80013780 0780033C */  lui        $v1, %hi(D_800756D0)
/* 3F84 80013784 D056638C */  lw         $v1, %lo(D_800756D0)($v1)
...
/* 412C 8001392C 0780023C */  lui        $v0, %hi(D_800756D0)
/* 4130 80013930 D056428C */  lw         $v0, %lo(D_800756D0)($v0)
...
/* 41C4 800139C4 0780023C */  lui        $v0, %hi(D_80075964)
/* 41C8 800139C8 6459428C */  lw         $v0, %lo(D_80075964)($v0)
...
.L80013A70:
/* 4270 80013A70 0780023C */  lui        $v0, %hi(D_800756D0)
/* 4274 80013A74 D056428C */  lw         $v0, %lo(D_800756D0)($v0)
/* 4278 80013A78 0780013C */  lui        $at, %hi(D_80075918)
/* 427C 80013A7C 185920AC */  sw         $zero, %lo(D_80075918)($at)
...
/* 432C 80013B2C 0780013C */  lui        $at, %hi(D_80075918)
/* 4330 80013B30 185922AC */  sw         $v0, %lo(D_80075918)($at)
.L80013B34:
...
/* 4358 80013B58 0780013C */  lui        $at, %hi(D_8007570C)
/* 435C 80013B5C 0C5720AC */  sw         $zero, %lo(D_8007570C)($at)
/* 4360 80013B60 0780013C */  lui        $at, %hi(D_800756C0)
/* 4364 80013B64 C05620AC */  sw         $zero, %lo(D_800756C0)($at)
.L80013B68:
/* 4368 80013B68 0880043C */  lui        $a0, %hi(D_800786C8)
/* 436C 80013B6C C8868424 */  addiu      $a0, $a0, %lo(D_800786C8)
...
/* 4390 80013B90 0880013C */  lui        $at, %hi(D_800786D8)
/* 4394 80013B94 D88622AC */  sw         $v0, %lo(D_800786D8)($at)
/* 4398 80013B98 0400028E */  lw         $v0, 0x4($s0)
/* 439C 80013B9C 0880013C */  lui        $at, %hi(D_800786DC)
/* 43A0 80013BA0 DC8622AC */  sw         $v0, %lo(D_800786DC)($at)
...
/* 43DC 80013BDC 0880013C */  lui        $at, %hi(D_80078510)
/* 43E0 80013BE0 108522AC */  sw         $v0, %lo(D_80078510)($at)
...
/* 440C 80013C0C 0880013C */  lui        $at, %hi(D_80078510)
/* 4410 80013C10 21082400 */  addu       $at, $at, $a0
/* 4414 80013C14 108522AC */  sw         $v0, %lo(D_80078510)($at)
...
/* 4430 80013C30 0880013C */  lui        $at, %hi(D_800786E0)
/* 4434 80013C34 E08622AC */  sw         $v0, %lo(D_800786E0)($at)
/* 4438 80013C38 0400028E */  lw         $v0, 0x4($s0)
/* 443C 80013C3C 08001026 */  addiu      $s0, $s0, 0x8
/* 4440 80013C40 0880013C */  lui        $at, %hi(D_800786E4)
/* 4444 80013C44 E48622AC */  sw         $v0, %lo(D_800786E4)($at)
...
/* 4734 80013F34 0780013C */  lui        $at, %hi(D_80075828)
/* 4738 80013F38 285830AC */  sw         $s0, %lo(D_80075828)($at)
/* 473C 80013F3C 0000A28C */  lw         $v0, 0x0($a1)
/* 4740 80013F40 0780033C */  lui        $v1, %hi(D_80075828)
/* 4744 80013F44 2858638C */  lw         $v1, %lo(D_80075828)($v1)
...
.L80014084:
/* 4884 80014084 0780023C */  lui        $v0, %hi(D_80075714)
/* 4888 80014088 1457428C */  lw         $v0, %lo(D_80075714)($v0)
...
/* 48A0 800140A0 0780033C */  lui        $v1, %hi(D_800757B8)
/* 48A4 800140A4 B857638C */  lw         $v1, %lo(D_800757B8)($v1)
...
/* 48F8 800140F8 0780033C */  lui        $v1, %hi(D_80075714)
/* 48FC 800140FC 1457638C */  lw         $v1, %lo(D_80075714)($v1)
...
.L80014158:
/* 4958 80014158 0780043C */  lui        $a0, %hi(D_80075828)
/* 495C 8001415C 2858848C */  lw         $a0, %lo(D_80075828)($a0)
...
/* 498C 8001418C 0780013C */  lui        $at, %hi(D_80076378)
/* 4990 80014190 21082200 */  addu       $at, $at, $v0
/* 4994 80014194 7863228C */  lw         $v0, %lo(D_80076378)($at)
...
.L800141BC:
/* 49BC 800141BC 0780053C */  lui        $a1, %hi(D_80075828)
/* 49C0 800141C0 2858A58C */  lw         $a1, %lo(D_80075828)($a1)
...
/* 49EC 800141EC 0780043C */  lui        $a0, %hi(D_80075828)
/* 49F0 800141F0 2858848C */  lw         $a0, %lo(D_80075828)($a0)
/* 49F4 800141F4 F44C010C */  jal        func_800533D0
/* 49F8 800141F8 21209000 */   addu      $a0, $a0, $s0
/* 49FC 800141FC 0780023C */  lui        $v0, %hi(D_80075828)
/* 4A00 80014200 2858428C */  lw         $v0, %lo(D_80075828)($v0)
...
/* 4A48 80014248 0780023C */  lui        $v0, %hi(D_80075964)
/* 4A4C 8001424C 6459428C */  lw         $v0, %lo(D_80075964)($v0)
...
/* 4A80 80014280 0780043C */  lui        $a0, %hi(D_80075828)
/* 4A84 80014284 2858848C */  lw         $a0, %lo(D_80075828)($a0)
...
/* 4AA0 800142A0 0780043C */  lui        $a0, %hi(D_80075828)
/* 4AA4 800142A4 2858848C */  lw         $a0, %lo(D_80075828)($a0)
...
/* 4AD8 800142D8 0780023C */  lui        $v0, %hi(D_80075964)
/* 4ADC 800142DC 6459428C */  lw         $v0, %lo(D_80075964)($v0)
...
.L8001433C:
/* 4B3C 8001433C 0780023C */  lui        $v0, %hi(D_80075828)
/* 4B40 80014340 2858428C */  lw         $v0, %lo(D_80075828)($v0)
...
/* 4B80 80014380 0780023C */  lui        $v0, %hi(D_80075828)
/* 4B84 80014384 2858428C */  lw         $v0, %lo(D_80075828)($v0)
...
.L80014398:
/* 4B98 80014398 0780043C */  lui        $a0, %hi(D_80075828)
/* 4B9C 8001439C 2858848C */  lw         $a0, %lo(D_80075828)($a0)
...
.L800143B0:
/* 4BB0 800143B0 0780043C */  lui        $a0, %hi(D_80075828)
/* 4BB4 800143B4 2858848C */  lw         $a0, %lo(D_80075828)($a0)
...
/* 4C1C 8001441C 0880023C */  lui        $v0, %hi(D_800785F8)
/* 4C20 80014420 F885428C */  lw         $v0, %lo(D_800785F8)($v0)
...
/* 4C6C 8001446C 0780023C */  lui        $v0, %hi(D_800758CC)
/* 4C70 80014470 CC58428C */  lw         $v0, %lo(D_800758CC)($v0)
/* 4C74 80014474 00000000 */  nop
/* 4C78 80014478 09F84000 */  jalr       $v0
/* 4C7C 8001447C 21280000 */   addu      $a1, $zero, $zero
/* 4C80 80014480 0780013C */  lui        $at, %hi(D_80075898)
/* 4C84 80014484 985822AC */  sw         $v0, %lo(D_80075898)($at)
/* 4C88 80014488 8051010C */  jal        func_80054600
