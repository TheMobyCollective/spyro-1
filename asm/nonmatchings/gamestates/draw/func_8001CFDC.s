...
.L8001D018:
/* D818 8001D018 0780043C */  lui        $a0, %hi(D_80077030 + 0x28)
/* D81C 8001D01C 5870848C */  lw         $a0, %lo(D_80077030 + 0x28)($a0)
...
/* D854 8001D054 0780053C */  lui        $a1, %hi(D_80077030 + 0x44)
/* D858 8001D058 7470A58C */  lw         $a1, %lo(D_80077030 + 0x44)($a1)
...
/* D884 8001D084 0780053C */  lui        $a1, %hi(D_80077030 + 0x90)
/* D888 8001D088 C070A58C */  lw         $a1, %lo(D_80077030 + 0x90)($a1)
...
/* D8B8 8001D0B8 0780023C */  lui        $v0, %hi(D_80077030 + 0x88)
/* D8BC 8001D0BC B870428C */  lw         $v0, %lo(D_80077030 + 0x88)($v0)
...
/* D9A0 8001D1A0 0780053C */  lui        $a1, %hi(D_80077030 + 0x44)
/* D9A4 8001D1A4 7470A58C */  lw         $a1, %lo(D_80077030 + 0x44)($a1)
...
/* D9D0 8001D1D0 0780033C */  lui        $v1, %hi(D_80077030 + 0x88)
/* D9D4 8001D1D4 B870638C */  lw         $v1, %lo(D_80077030 + 0x88)($v1)
...
/* D9E4 8001D1E4 0780033C */  lui        $v1, %hi(D_80077030 + 0x8C)
/* D9E8 8001D1E8 BC70638C */  lw         $v1, %lo(D_80077030 + 0x8C)($v1)
...
/* DA64 8001D264 0780023C */  lui        $v0, %hi(D_80077030 + 0x3C)
/* DA68 8001D268 6C70428C */  lw         $v0, %lo(D_80077030 + 0x3C)($v0)
...
/* DADC 8001D2DC 0780033C */  lui        $v1, %hi(D_80077030 + 0x88)
/* DAE0 8001D2E0 B870638C */  lw         $v1, %lo(D_80077030 + 0x88)($v1)
...
/* DB30 8001D330 0780023C */  lui        $v0, %hi(D_80077030 + 0x3C)
/* DB34 8001D334 6C70428C */  lw         $v0, %lo(D_80077030 + 0x3C)($v0)
...
/* DB94 8001D394 0780033C */  lui        $v1, %hi(D_80077030 + 0x3C)
/* DB98 8001D398 6C70638C */  lw         $v1, %lo(D_80077030 + 0x3C)($v1)
...
/* DD18 8001D518 0780023C */  lui        $v0, %hi(D_80077030 + 0x3C)
/* DD1C 8001D51C 6C70428C */  lw         $v0, %lo(D_80077030 + 0x3C)($v0)
...
.L8001D624:
/* DE24 8001D624 0780053C */  lui        $a1, %hi(D_80077030 + 0x44)
/* DE28 8001D628 7470A58C */  lw         $a1, %lo(D_80077030 + 0x44)($a1)
