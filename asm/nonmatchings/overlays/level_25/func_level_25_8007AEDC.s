...
/* 258FCBC 8007AEF4 0880053C */  lui        $a1, %hi(D_800785F0)
/* 258FCC0 8007AEF8 F085A58C */  lw         $a1, %lo(D_800785F0)($a1)
...
/* 258FD08 8007AF40 08800D3C */  lui        $t5, %hi(D_80078680)
/* 258FD0C 8007AF44 8086AD25 */  addiu      $t5, $t5, %lo(D_80078680)
...
/* 258FD24 8007AF5C 0880093C */  lui        $t1, %hi(D_80078630)
/* 258FD28 8007AF60 30862925 */  addiu      $t1, $t1, %lo(D_80078630)
.Llevel_25_8007AF64:
...
/* 258FD3C 8007AF74 0780033C */  lui        $v1, %hi(D_8007595C)
/* 258FD40 8007AF78 5C59638C */  lw         $v1, %lo(D_8007595C)($v1)
...
/* 258FD70 8007AFA8 0780043C */  lui        $a0, %hi(D_80075964)
/* 258FD74 8007AFAC 6459848C */  lw         $a0, %lo(D_80075964)($a0)
...
/* 258FDD4 8007B00C 0880023C */  lui        $v0, %hi(D_80078630)
/* 258FDD8 8007B010 3086428C */  lw         $v0, %lo(D_80078630)($v0)
/* 258FDDC 8007B014 0880033C */  lui        $v1, %hi(D_80078634)
/* 258FDE0 8007B018 3486638C */  lw         $v1, %lo(D_80078634)($v1)
/* 258FDE4 8007B01C 00000000 */  nop
/* 258FDE8 8007B020 21104300 */  addu       $v0, $v0, $v1
/* 258FDEC 8007B024 0880033C */  lui        $v1, %hi(D_80078638)
/* 258FDF0 8007B028 3886638C */  lw         $v1, %lo(D_80078638)($v1)
/* 258FDF4 8007B02C 0880043C */  lui        $a0, %hi(D_8007863C)
/* 258FDF8 8007B030 3C86848C */  lw         $a0, %lo(D_8007863C)($a0)
...
/* 258FE10 8007B048 0780023C */  lui        $v0, %hi(D_8007595C)
/* 258FE14 8007B04C 5C59428C */  lw         $v0, %lo(D_8007595C)($v0)
/* 258FE18 8007B050 00000000 */  nop
/* 258FE1C 8007B054 80180200 */  sll        $v1, $v0, 2
/* 258FE20 8007B058 21306200 */  addu       $a2, $v1, $v0
/* 258FE24 8007B05C 0880013C */  lui        $at, %hi(D_80078680 + 0x04)
/* 258FE28 8007B060 21082600 */  addu       $at, $at, $a2
/* 258FE2C 8007B064 84862290 */  lbu        $v0, %lo(D_80078680 + 0x04)($at)
...
/* 258FE44 8007B07C 0780043C */  lui        $a0, %hi(D_80075964)
/* 258FE48 8007B080 6459848C */  lw         $a0, %lo(D_80075964)($a0)
...
/* 258FEA8 8007B0E0 0880013C */  lui        $at, %hi(D_80078680 + 0x04)
/* 258FEAC 8007B0E4 21082600 */  addu       $at, $at, $a2
/* 258FEB0 8007B0E8 848622A0 */  sb         $v0, %lo(D_80078680 + 0x04)($at)
.Llevel_25_8007B0EC:
/* 258FEB4 8007B0EC 0780023C */  lui        $v0, %hi(D_8007595C)
/* 258FEB8 8007B0F0 5C59428C */  lw         $v0, %lo(D_8007595C)($v0)
/* 258FEBC 8007B0F4 0880033C */  lui        $v1, %hi(D_80078618)
/* 258FEC0 8007B0F8 18866324 */  addiu      $v1, $v1, %lo(D_80078618)
...
/* 258FF54 8007B18C 0780013C */  lui        $at, %hi(D_80077DB8)
/* 258FF58 8007B190 21082200 */  addu       $at, $at, $v0
/* 258FF5C 8007B194 B87D23A0 */  sb         $v1, %lo(D_80077DB8)($at)
