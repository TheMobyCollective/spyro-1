...
/* 2727E6C 8007B8A4 0780013C */  lui        $at, %hi(D_800777E8 + 0x4)
/* 2727E70 8007B8A8 EC7720AC */  sw         $zero, %lo(D_800777E8 + 0x4)($at)
/* 2727E74 8007B8AC 0780013C */  lui        $at, %hi(D_800777E8 + 0x8)
/* 2727E78 8007B8B0 F07720AC */  sw         $zero, %lo(D_800777E8 + 0x8)($at)
/* 2727E7C 8007B8B4 0780013C */  lui        $at, %hi(D_800777E8 + 0x64)
/* 2727E80 8007B8B8 4C7830AC */  sw         $s0, %lo(D_800777E8 + 0x64)($at)
...
/* 2727E90 8007B8C8 0780013C */  lui        $at, %hi(g_ScreenBorderEnabled)
/* 2727E94 8007B8CC 0C5722AC */  sw         $v0, %lo(g_ScreenBorderEnabled)($at)
...
/* 2727EB0 8007B8E8 0780033C */  lui        $v1, %hi(g_LevelMobys)
/* 2727EB4 8007B8EC 2858638C */  lw         $v1, %lo(g_LevelMobys)($v1)
/* 2727EB8 8007B8F0 C0100200 */  sll        $v0, $v0, 3
/* 2727EBC 8007B8F4 21186200 */  addu       $v1, $v1, $v0
/* 2727EC0 8007B8F8 0780013C */  lui        $at, %hi(D_800777E8 + 0x68)
/* 2727EC4 8007B8FC 507823AC */  sw         $v1, %lo(D_800777E8 + 0x68)($at)
...
/* 2727EF0 8007B928 0780013C */  lui        $at, %hi(D_800777E8 + 0x38)
/* 2727EF4 8007B92C 207822AC */  sw         $v0, %lo(D_800777E8 + 0x38)($at)
/* 2727EF8 8007B930 E35D000C */  jal        VecSub
/* 2727EFC 8007B934 0C000626 */   addiu     $a2, $s0, 0xC
/* 2727F00 8007B938 1000A427 */  addiu      $a0, $sp, 0x10
/* 2727F04 8007B93C 7F5C000C */  jal        VecMagnitude
...
/* 2727F14 8007B94C 0780013C */  lui        $at, %hi(D_800777E8 + 0x3C)
/* 2727F18 8007B950 247822AC */  sw         $v0, %lo(D_800777E8 + 0x3C)($at)
/* 2727F1C 8007B954 0780013C */  lui        $at, %hi(D_800777E8 + 0x40)
/* 2727F20 8007B958 287823AC */  sw         $v1, %lo(D_800777E8 + 0x40)($at)
/* 2727F24 8007B95C 46000292 */  lbu        $v0, 0x46($s0)
/* 2727F28 8007B960 2E050324 */  addiu      $v1, $zero, 0x52E
/* 2727F2C 8007B964 0780013C */  lui        $at, %hi(D_800777E8 + 0x54)
/* 2727F30 8007B968 3C7823AC */  sw         $v1, %lo(D_800777E8 + 0x54)($at)
...
/* 2727F40 8007B978 0780013C */  lui        $at, %hi(D_800777E8 + 0x50)
/* 2727F44 8007B97C 387822AC */  sw         $v0, %lo(D_800777E8 + 0x50)($at)
/* 2727F48 8007B980 1400028E */  lw         $v0, 0x14($s0)
/* 2727F4C 8007B984 00000000 */  nop
/* 2727F50 8007B988 8F054224 */  addiu      $v0, $v0, 0x58F
/* 2727F54 8007B98C 0780013C */  lui        $at, %hi(D_800777E8 + 0x58)
/* 2727F58 8007B990 407822AC */  sw         $v0, %lo(D_800777E8 + 0x58)($at)
