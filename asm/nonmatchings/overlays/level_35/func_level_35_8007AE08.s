...
/* 33DFC04 8007AE3C 0880043C */  lui        $a0, %hi(g_FlightCourseRecords)
/* 33DFC08 8007AE40 18868424 */  addiu      $a0, $a0, %lo(g_FlightCourseRecords)
...
/* 33DFC5C 8007AE94 0880023C */  lui        $v0, %hi(g_FlightObjectiveCounters)
/* 33DFC60 8007AE98 3086428C */  lw         $v0, %lo(g_FlightObjectiveCounters)($v0)
/* 33DFC64 8007AE9C 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x4)
/* 33DFC68 8007AEA0 3486638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x4)($v1)
/* 33DFC6C 8007AEA4 00000000 */  nop
/* 33DFC70 8007AEA8 21104300 */  addu       $v0, $v0, $v1
/* 33DFC74 8007AEAC 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x8)
/* 33DFC78 8007AEB0 3886638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x8)($v1)
/* 33DFC7C 8007AEB4 0880043C */  lui        $a0, %hi(g_FlightObjectiveCounters + 0xC)
/* 33DFC80 8007AEB8 3C86848C */  lw         $a0, %lo(g_FlightObjectiveCounters + 0xC)($a0)
