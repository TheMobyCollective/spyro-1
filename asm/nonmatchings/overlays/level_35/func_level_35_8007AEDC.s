...
/* 33DFCBC 8007AEF4 0880053C */  lui        $a1, %hi(g_Buffers + 0x18)
/* 33DFCC0 8007AEF8 F085A58C */  lw         $a1, %lo(g_Buffers + 0x18)($a1)
...
/* 33DFD08 8007AF40 08800D3C */  lui        $t5, %hi(g_FlightCollected)
/* 33DFD0C 8007AF44 8086AD25 */  addiu      $t5, $t5, %lo(g_FlightCollected)
...
/* 33DFD24 8007AF5C 0880093C */  lui        $t1, %hi(g_FlightObjectiveCounters)
/* 33DFD28 8007AF60 30862925 */  addiu      $t1, $t1, %lo(g_FlightObjectiveCounters)
.Llevel_35_8007AF64:
...
/* 33DFD3C 8007AF74 0780033C */  lui        $v1, %hi(g_Homeworld)
/* 33DFD40 8007AF78 5C59638C */  lw         $v1, %lo(g_Homeworld)($v1)
...
/* 33DFD70 8007AFA8 0780043C */  lui        $a0, %hi(g_LevelIndex)
/* 33DFD74 8007AFAC 6459848C */  lw         $a0, %lo(g_LevelIndex)($a0)
...
/* 33DFD9C 8007AFD4 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 33DFDA0 8007AFD8 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
/* 33DFDA4 8007AFDC 0000A48C */  lw         $a0, 0x0($a1)
/* 33DFDA8 8007AFE0 0C004224 */  addiu      $v0, $v0, 0xC
/* 33DFDAC 8007AFE4 21186400 */  addu       $v1, $v1, $a0
/* 33DFDB0 8007AFE8 0780013C */  lui        $at, %hi(g_NGemsSinceLevelEntry)
/* 33DFDB4 8007AFEC C85622AC */  sw         $v0, %lo(g_NGemsSinceLevelEntry)($at)
...
/* 33DFDD4 8007B00C 0880023C */  lui        $v0, %hi(g_FlightObjectiveCounters)
/* 33DFDD8 8007B010 3086428C */  lw         $v0, %lo(g_FlightObjectiveCounters)($v0)
/* 33DFDDC 8007B014 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x4)
/* 33DFDE0 8007B018 3486638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x4)($v1)
/* 33DFDE4 8007B01C 00000000 */  nop
/* 33DFDE8 8007B020 21104300 */  addu       $v0, $v0, $v1
/* 33DFDEC 8007B024 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x8)
/* 33DFDF0 8007B028 3886638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x8)($v1)
/* 33DFDF4 8007B02C 0880043C */  lui        $a0, %hi(g_FlightObjectiveCounters + 0xC)
/* 33DFDF8 8007B030 3C86848C */  lw         $a0, %lo(g_FlightObjectiveCounters + 0xC)($a0)
...
/* 33DFE10 8007B048 0780023C */  lui        $v0, %hi(g_Homeworld)
/* 33DFE14 8007B04C 5C59428C */  lw         $v0, %lo(g_Homeworld)($v0)
/* 33DFE18 8007B050 00000000 */  nop
/* 33DFE1C 8007B054 80180200 */  sll        $v1, $v0, 2
/* 33DFE20 8007B058 21306200 */  addu       $a2, $v1, $v0
/* 33DFE24 8007B05C 0880013C */  lui        $at, %hi(g_FlightCollected + 0x04)
/* 33DFE28 8007B060 21082600 */  addu       $at, $at, $a2
/* 33DFE2C 8007B064 84862290 */  lbu        $v0, %lo(g_FlightCollected + 0x04)($at)
...
/* 33DFE44 8007B07C 0780043C */  lui        $a0, %hi(g_LevelIndex)
/* 33DFE48 8007B080 6459848C */  lw         $a0, %lo(g_LevelIndex)($a0)
...
/* 33DFE78 8007B0B0 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 33DFE7C 8007B0B4 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
...
/* 33DFE94 8007B0CC 0780013C */  lui        $at, %hi(g_NGemsSinceLevelEntry)
/* 33DFE98 8007B0D0 C85622AC */  sw         $v0, %lo(g_NGemsSinceLevelEntry)($at)
...
/* 33DFEA8 8007B0E0 0880013C */  lui        $at, %hi(g_FlightCollected + 0x04)
/* 33DFEAC 8007B0E4 21082600 */  addu       $at, $at, $a2
/* 33DFEB0 8007B0E8 848622A0 */  sb         $v0, %lo(g_FlightCollected + 0x04)($at)
.Llevel_35_8007B0EC:
/* 33DFEB4 8007B0EC 0780023C */  lui        $v0, %hi(g_Homeworld)
/* 33DFEB8 8007B0F0 5C59428C */  lw         $v0, %lo(g_Homeworld)($v0)
/* 33DFEBC 8007B0F4 0880033C */  lui        $v1, %hi(g_FlightCourseRecords)
/* 33DFEC0 8007B0F8 18866324 */  addiu      $v1, $v1, %lo(g_FlightCourseRecords)
...
.Llevel_35_8007B13C:
/* 33DFF04 8007B13C 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 33DFF08 8007B140 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
...
/* 33DFF54 8007B18C 0780013C */  lui        $at, %hi(g_RecentGemsCollected)
/* 33DFF58 8007B190 21082200 */  addu       $at, $at, $v0
/* 33DFF5C 8007B194 B87D23A0 */  sb         $v1, %lo(g_RecentGemsCollected)($at)
/* 33DFF60 8007B198 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 33DFF64 8007B19C C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
