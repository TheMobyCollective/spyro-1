...
/* 1E02D14 8007B74C 0780013C */  lui        $at, %hi(D_800777E8 + 0x4)
/* 1E02D18 8007B750 EC7720AC */  sw         $zero, %lo(D_800777E8 + 0x4)($at)
/* 1E02D1C 8007B754 0780013C */  lui        $at, %hi(D_800777E8 + 0x8)
/* 1E02D20 8007B758 F07720AC */  sw         $zero, %lo(D_800777E8 + 0x8)($at)
/* 1E02D24 8007B75C 0780013C */  lui        $at, %hi(D_800777E8 + 0x64)
/* 1E02D28 8007B760 4C7830AC */  sw         $s0, %lo(D_800777E8 + 0x64)($at)
...
/* 1E02D38 8007B770 0780013C */  lui        $at, %hi(g_ScreenBorderEnabled)
/* 1E02D3C 8007B774 0C5722AC */  sw         $v0, %lo(g_ScreenBorderEnabled)($at)
...
/* 1E02D58 8007B790 0780033C */  lui        $v1, %hi(g_LevelMobys)
/* 1E02D5C 8007B794 2858638C */  lw         $v1, %lo(g_LevelMobys)($v1)
/* 1E02D60 8007B798 C0100200 */  sll        $v0, $v0, 3
/* 1E02D64 8007B79C 21186200 */  addu       $v1, $v1, $v0
/* 1E02D68 8007B7A0 0780013C */  lui        $at, %hi(D_800777E8 + 0x68)
/* 1E02D6C 8007B7A4 507823AC */  sw         $v1, %lo(D_800777E8 + 0x68)($at)
...
/* 1E02D88 8007B7C0 AD5A000C */  jal        Atan2
...
/* 1E02D98 8007B7D0 0780013C */  lui        $at, %hi(D_800777E8 + 0x38)
/* 1E02D9C 8007B7D4 207822AC */  sw         $v0, %lo(D_800777E8 + 0x38)($at)
/* 1E02DA0 8007B7D8 E35D000C */  jal        VecSub
/* 1E02DA4 8007B7DC 0C000626 */   addiu     $a2, $s0, 0xC
/* 1E02DA8 8007B7E0 1000A427 */  addiu      $a0, $sp, 0x10
/* 1E02DAC 8007B7E4 7F5C000C */  jal        VecMagnitude
...
/* 1E02DBC 8007B7F4 0780013C */  lui        $at, %hi(D_800777E8 + 0x3C)
/* 1E02DC0 8007B7F8 247822AC */  sw         $v0, %lo(D_800777E8 + 0x3C)($at)
/* 1E02DC4 8007B7FC 0780013C */  lui        $at, %hi(D_800777E8 + 0x40)
/* 1E02DC8 8007B800 287823AC */  sw         $v1, %lo(D_800777E8 + 0x40)($at)
/* 1E02DCC 8007B804 46000292 */  lbu        $v0, 0x46($s0)
/* 1E02DD0 8007B808 2E050324 */  addiu      $v1, $zero, 0x52E
/* 1E02DD4 8007B80C 0780013C */  lui        $at, %hi(D_800777E8 + 0x54)
/* 1E02DD8 8007B810 3C7823AC */  sw         $v1, %lo(D_800777E8 + 0x54)($at)
...
/* 1E02DE8 8007B820 0780013C */  lui        $at, %hi(D_800777E8 + 0x50)
/* 1E02DEC 8007B824 387822AC */  sw         $v0, %lo(D_800777E8 + 0x50)($at)
/* 1E02DF0 8007B828 1400028E */  lw         $v0, 0x14($s0)
/* 1E02DF4 8007B82C 00000000 */  nop
/* 1E02DF8 8007B830 8F054224 */  addiu      $v0, $v0, 0x58F
/* 1E02DFC 8007B834 0780013C */  lui        $at, %hi(D_800777E8 + 0x58)
/* 1E02E00 8007B838 407822AC */  sw         $v0, %lo(D_800777E8 + 0x58)($at)
