...
/* 358CC60 8007B698 0780013C */  lui        $at, %hi(D_800777E8 + 0x4)
/* 358CC64 8007B69C EC7720AC */  sw         $zero, %lo(D_800777E8 + 0x4)($at)
/* 358CC68 8007B6A0 0780013C */  lui        $at, %hi(D_800777E8 + 0x8)
/* 358CC6C 8007B6A4 F07720AC */  sw         $zero, %lo(D_800777E8 + 0x8)($at)
/* 358CC70 8007B6A8 0780013C */  lui        $at, %hi(D_800777E8 + 0x64)
/* 358CC74 8007B6AC 4C7830AC */  sw         $s0, %lo(D_800777E8 + 0x64)($at)
...
/* 358CC84 8007B6BC 0780013C */  lui        $at, %hi(g_ScreenBorderEnabled)
/* 358CC88 8007B6C0 0C5722AC */  sw         $v0, %lo(g_ScreenBorderEnabled)($at)
...
/* 358CCA4 8007B6DC 0780033C */  lui        $v1, %hi(g_LevelMobys)
/* 358CCA8 8007B6E0 2858638C */  lw         $v1, %lo(g_LevelMobys)($v1)
/* 358CCAC 8007B6E4 C0100200 */  sll        $v0, $v0, 3
/* 358CCB0 8007B6E8 21186200 */  addu       $v1, $v1, $v0
/* 358CCB4 8007B6EC 0780013C */  lui        $at, %hi(D_800777E8 + 0x68)
/* 358CCB8 8007B6F0 507823AC */  sw         $v1, %lo(D_800777E8 + 0x68)($at)
...
/* 358CCD4 8007B70C AD5A000C */  jal        Atan2
...
/* 358CCE4 8007B71C 0780013C */  lui        $at, %hi(D_800777E8 + 0x38)
/* 358CCE8 8007B720 207822AC */  sw         $v0, %lo(D_800777E8 + 0x38)($at)
...
/* 358CD08 8007B740 0780013C */  lui        $at, %hi(D_800777E8 + 0x3C)
/* 358CD0C 8007B744 247822AC */  sw         $v0, %lo(D_800777E8 + 0x3C)($at)
/* 358CD10 8007B748 0780013C */  lui        $at, %hi(D_800777E8 + 0x40)
/* 358CD14 8007B74C 287823AC */  sw         $v1, %lo(D_800777E8 + 0x40)($at)
/* 358CD18 8007B750 46000292 */  lbu        $v0, 0x46($s0)
/* 358CD1C 8007B754 2E050324 */  addiu      $v1, $zero, 0x52E
/* 358CD20 8007B758 0780013C */  lui        $at, %hi(D_800777E8 + 0x54)
/* 358CD24 8007B75C 3C7823AC */  sw         $v1, %lo(D_800777E8 + 0x54)($at)
...
/* 358CD34 8007B76C 0780013C */  lui        $at, %hi(D_800777E8 + 0x50)
/* 358CD38 8007B770 387822AC */  sw         $v0, %lo(D_800777E8 + 0x50)($at)
/* 358CD3C 8007B774 1400028E */  lw         $v0, 0x14($s0)
/* 358CD40 8007B778 00000000 */  nop
/* 358CD44 8007B77C 8F054224 */  addiu      $v0, $v0, 0x58F
/* 358CD48 8007B780 0780013C */  lui        $at, %hi(D_800777E8 + 0x58)
/* 358CD4C 8007B784 407822AC */  sw         $v0, %lo(D_800777E8 + 0x58)($at)
