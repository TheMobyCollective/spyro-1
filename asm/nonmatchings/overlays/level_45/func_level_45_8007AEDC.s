...
/* 4256CBC 8007AEF4 0880053C */  lui        $a1, %hi(g_Buffers + 0x18)
/* 4256CC0 8007AEF8 F085A58C */  lw         $a1, %lo(g_Buffers + 0x18)($a1)
...
/* 4256D08 8007AF40 08800D3C */  lui        $t5, %hi(g_FlightCollected)
/* 4256D0C 8007AF44 8086AD25 */  addiu      $t5, $t5, %lo(g_FlightCollected)
...
/* 4256D9C 8007AFD4 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 4256DA0 8007AFD8 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
/* 4256DA4 8007AFDC 0000A48C */  lw         $a0, 0x0($a1)
/* 4256DA8 8007AFE0 0C004224 */  addiu      $v0, $v0, 0xC
/* 4256DAC 8007AFE4 21186400 */  addu       $v1, $v1, $a0
/* 4256DB0 8007AFE8 0780013C */  lui        $at, %hi(g_NGemsSinceLevelEntry)
/* 4256DB4 8007AFEC C85622AC */  sw         $v0, %lo(g_NGemsSinceLevelEntry)($at)
...
/* 4256DDC 8007B014 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x4)
/* 4256DE0 8007B018 3486638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x4)($v1)
/* 4256DE4 8007B01C 00000000 */  nop
/* 4256DE8 8007B020 21104300 */  addu       $v0, $v0, $v1
/* 4256DEC 8007B024 0880033C */  lui        $v1, %hi(g_FlightObjectiveCounters + 0x8)
/* 4256DF0 8007B028 3886638C */  lw         $v1, %lo(g_FlightObjectiveCounters + 0x8)($v1)
/* 4256DF4 8007B02C 0880043C */  lui        $a0, %hi(g_FlightObjectiveCounters + 0xC)
/* 4256DF8 8007B030 3C86848C */  lw         $a0, %lo(g_FlightObjectiveCounters + 0xC)($a0)
...
/* 4256E24 8007B05C 0880013C */  lui        $at, %hi(g_FlightCollected + 0x04)
/* 4256E28 8007B060 21082600 */  addu       $at, $at, $a2
/* 4256E2C 8007B064 84862290 */  lbu        $v0, %lo(g_FlightCollected + 0x04)($at)
...
/* 4256E78 8007B0B0 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 4256E7C 8007B0B4 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
...
/* 4256E94 8007B0CC 0780013C */  lui        $at, %hi(g_NGemsSinceLevelEntry)
/* 4256E98 8007B0D0 C85622AC */  sw         $v0, %lo(g_NGemsSinceLevelEntry)($at)
...
/* 4256EA8 8007B0E0 0880013C */  lui        $at, %hi(g_FlightCollected + 0x04)
/* 4256EAC 8007B0E4 21082600 */  addu       $at, $at, $a2
/* 4256EB0 8007B0E8 848622A0 */  sb         $v0, %lo(g_FlightCollected + 0x04)($at)
.Llevel_45_8007B0EC:
/* 4256EB4 8007B0EC 0780023C */  lui        $v0, %hi(g_Homeworld)
/* 4256EB8 8007B0F0 5C59428C */  lw         $v0, %lo(g_Homeworld)($v0)
/* 4256EBC 8007B0F4 0880033C */  lui        $v1, %hi(g_FlightCourseRecords)
/* 4256EC0 8007B0F8 18866324 */  addiu      $v1, $v1, %lo(g_FlightCourseRecords)
...
.Llevel_45_8007B13C:
/* 4256F04 8007B13C 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 4256F08 8007B140 C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
...
/* 4256F60 8007B198 0780023C */  lui        $v0, %hi(g_NGemsSinceLevelEntry)
/* 4256F64 8007B19C C856428C */  lw         $v0, %lo(g_NGemsSinceLevelEntry)($v0)
