...
/* 51E340C 8007AE44 0780013C */  lui        $at, %hi(D_800777EC)
/* 51E3410 8007AE48 EC7720AC */  sw         $zero, %lo(D_800777EC)($at)
/* 51E3414 8007AE4C 0780013C */  lui        $at, %hi(D_800777F0)
/* 51E3418 8007AE50 F07720AC */  sw         $zero, %lo(D_800777F0)($at)
/* 51E341C 8007AE54 0780013C */  lui        $at, %hi(D_8007784C)
/* 51E3420 8007AE58 4C7830AC */  sw         $s0, %lo(D_8007784C)($at)
...
/* 51E3430 8007AE68 0780013C */  lui        $at, %hi(D_8007570C)
/* 51E3434 8007AE6C 0C5722AC */  sw         $v0, %lo(D_8007570C)($at)
...
/* 51E3450 8007AE88 0780033C */  lui        $v1, %hi(D_80075828)
/* 51E3454 8007AE8C 2858638C */  lw         $v1, %lo(D_80075828)($v1)
/* 51E3458 8007AE90 C0100200 */  sll        $v0, $v0, 3
/* 51E345C 8007AE94 21186200 */  addu       $v1, $v1, $v0
/* 51E3460 8007AE98 0780013C */  lui        $at, %hi(D_80077850)
/* 51E3464 8007AE9C 507823AC */  sw         $v1, %lo(D_80077850)($at)
...
/* 51E3480 8007AEB8 AD5A000C */  jal        func_80016AB4
...
/* 51E3490 8007AEC8 0780013C */  lui        $at, %hi(D_80077820)
/* 51E3494 8007AECC 207822AC */  sw         $v0, %lo(D_80077820)($at)
/* 51E3498 8007AED0 E35D000C */  jal        VecSub
/* 51E349C 8007AED4 0C000626 */   addiu     $a2, $s0, 0xC
/* 51E34A0 8007AED8 1000A427 */  addiu      $a0, $sp, 0x10
/* 51E34A4 8007AEDC 7F5C000C */  jal        func_800171FC
...
/* 51E34B4 8007AEEC 0780013C */  lui        $at, %hi(D_80077824)
/* 51E34B8 8007AEF0 247822AC */  sw         $v0, %lo(D_80077824)($at)
/* 51E34BC 8007AEF4 0780013C */  lui        $at, %hi(D_80077828)
/* 51E34C0 8007AEF8 287823AC */  sw         $v1, %lo(D_80077828)($at)
/* 51E34C4 8007AEFC 46000292 */  lbu        $v0, 0x46($s0)
/* 51E34C8 8007AF00 2E050324 */  addiu      $v1, $zero, 0x52E
/* 51E34CC 8007AF04 0780013C */  lui        $at, %hi(D_8007783C)
/* 51E34D0 8007AF08 3C7823AC */  sw         $v1, %lo(D_8007783C)($at)
...
/* 51E34E0 8007AF18 0780013C */  lui        $at, %hi(D_80077838)
/* 51E34E4 8007AF1C 387822AC */  sw         $v0, %lo(D_80077838)($at)
/* 51E34E8 8007AF20 1400028E */  lw         $v0, 0x14($s0)
/* 51E34EC 8007AF24 00000000 */  nop
/* 51E34F0 8007AF28 8F054224 */  addiu      $v0, $v0, 0x58F
/* 51E34F4 8007AF2C 0780013C */  lui        $at, %hi(D_80077840)
/* 51E34F8 8007AF30 407822AC */  sw         $v0, %lo(D_80077840)($at)
